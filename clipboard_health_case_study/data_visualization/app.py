...
df = pd.read_csv("../one_month_calculated_metrics.csv")

st.title("Best Staff Allocation Combination for Max Revenue - One Month View")
...
revenue_bars = ax.bar([p - width/2 for p in positions], df["Cumulative Revenue"], width=width, color="blue", label="Cumulative Revenue")
